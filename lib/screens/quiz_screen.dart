...
class _QuizScreenState extends State<QuizScreen> {
  ...
  Future<void> _loadWords() async {
    // JSON?êÏÑú ?®Ïñ¥ Î°úÎìú (?¥Ïû• Î≤àÏó≠ ?¨Ìï®)
    ...
    // Î™®Îì† ?®Ïñ¥???Ä???¥Ïû• Î≤àÏó≠ Î°úÎìú (?§Îãµ ?†ÌÉùÏßÄ??Î≤àÏó≠?òÏñ¥????
    if (translationService.needsTranslation) {
      for (var word in words) {
        // ?¥Ïû• Î≤àÏó≠Îß??ïÏù∏ (API ?∏Ï∂ú ?ÜÏùå)
        ...
        // ?¥Ïû• Î≤àÏó≠ ?ÜÏúºÎ©??ÅÏñ¥ ?êÎ≥∏ ?¨Ïö© (API ?∏Ï∂ú ?àÌï® - ?¥Ï¶à ?çÎèÑ ?∞ÏÑ†)
      }
    }
